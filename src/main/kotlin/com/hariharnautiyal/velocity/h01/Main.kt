...
class Main @Inject constructor(
    ...
    private fun startManagers() {
        try {
            ...
            authenticationEvents = if (floodgateApi != null) {
    ...
    private fun registerCommands() {
        ...
        val payCommandMeta: CommandMeta = commandManager.metaBuilder("transfer")
            .aliases("p", "pay")
            .plugin(this)
            .build()

        val balanceCommandMeta: CommandMeta = commandManager.metaBuilder("balance")
            .aliases("b", "bal")
            .plugin(this)
            .build()
...
data class PluginConfig(
    ...
    val mongo: MongoDBConfiguration = MongoDBConfiguration(
        host = "localhost",
        port = 27017,
        database = "h01",
        username = null,
    ...
    val redis: RedisConfiguration = RedisConfiguration(
        host = "localhost",
        port = 6379,
        password = null
    ),
